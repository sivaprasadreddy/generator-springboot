...
type FileContentsToVerify = {
    [key: string]: ContentCheck[];
};

describe('SpringBoot Generator', () => {
    // Helper function to test server generator with different configurations
    const testServerGenerator = async (testName: string, options: TestOptions, expectedFiles: string[], fileContentsToVerify: FileContentsToVerify = {}) => {
        it(testName, async () => {
    ...
    describe('Maven build tool tests', () => {
        testServerGenerator(
            'creates minimal microservice with maven',
            {
                "appName": "myservice",
        ...
        testServerGenerator(
            'creates basic microservice with maven and Flyway',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates basic microservice with maven and Liquibase',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice", 
        ...
        testServerGenerator(
            'creates complete microservice with maven, ELK and monitoring',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
    ...
    describe('Gradle build tool tests', () => {
        testServerGenerator(
            'creates minimal microservice with Gradle',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates basic microservice with Gradle and Flyway',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates basic microservice with Gradle and Liquibase',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates complete microservice with Gradle, ELK and monitoring',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
    ...
    describe('Advanced server configuration tests', () => {
        testServerGenerator(
            'creates microservice with MySQL database',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates microservice with MariaDB database',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates microservice with localstack feature',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
        ...
        testServerGenerator(
            'creates Java sources with correct package structure',
            {
                "appName": "customapp",
        ...
        testServerGenerator(
            'creates microservice with correct application name in properties file',
            {
        ...
        testServerGenerator(
            'creates test resources and configuration',
            {
                "appName": "myservice",
                "packageName": "com.mycompany.myservice",
                "packageFolder": "com/mycompany/myservice",
    ...
    describe('Validation and edge cases', () => {
        testServerGenerator(
            'handles project names with hyphens correctly',
            {
        ...
        testServerGenerator(
            'handles package names with multiple levels',
            {
                "appName": "api-gateway",
