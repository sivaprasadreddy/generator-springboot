...
// Define a custom type for options since we can't import GeneratorOptions directly
type YeomanCompatibleOptions = Record<string, any>;
...
describe('SpringBoot Generator', () => {
    ...
    const testControllerGenerator = async (
        testName: string, 
        entityName: string, 
        options: ControllerOptions, 
        templateDir: string, 
        expectedFiles: string[], 
        fileContentsToVerify: FileContentsToVerify = {}, 
