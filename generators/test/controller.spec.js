...
describe('SpringBoot Generator', () => {
    ...
    const testControllerGenerator = async (testName, entityName, options, templateDir, expectedFiles, fileContentsToVerify = {}, additionalChecks) => {
        it(testName, async () => {
            ...
            // Cast options to compatible type and combine all options in one call
            const allOptions = {
                ...options,
                formatCode: false
            };
    ...
    describe('Generate CRUD API with Flyway', () => {
        testControllerGenerator('creates expected default files for CRUD API with Flyway', 'Customer', { 'base-path': '/api/customers' }, '../test/templates/basic-microservice-flyway', [
        ...
        testControllerGenerator('creates expected test files for CRUD API with Flyway', 'Product', { 'base-path': '/api/products' }, '../test/templates/basic-microservice-flyway', [
        ...
        testControllerGenerator('creates entity with validation annotations', 'Task', { 'base-path': '/api/tasks', 'with-validation': true }, '../test/templates/basic-microservice-flyway', [
    ...
    describe('Generate CRUD API with Liquibase', () => {
        testControllerGenerator('creates expected default files for CRUD API with Liquibase', 'Customer', { 'base-path': '/api/customers' }, '../test/templates/basic-microservice-liquibase', [
            'src/main/java/com/mycompany/myservice/entities/Customer.java',
            'src/main/java/com/mycompany/myservice/repositories/CustomerRepository.java',
            'src/main/java/com/mycompany/myservice/services/CustomerService.java',
            'src/main/java/com/mycompany/myservice/web/controllers/CustomerController.java',
        ...
        testControllerGenerator('creates expected test files for CRUD API with Liquibase', 'Order', { 'base-path': '/api/orders' }, '../test/templates/basic-microservice-liquibase', [
    ...
    describe('Generate CRUD API with custom options', () => {
        testControllerGenerator('creates API with custom base path', 'User', { 'base-path': '/v1/users' }, '../test/templates/basic-microservice-flyway', [
        ...
        testControllerGenerator('creates API with camel case entity name', 'TodoItem', { 'base-path': '/api/todo-items' }, '../test/templates/basic-microservice-flyway', [
    ...
    describe('Edge cases and error handling', () => {
        testControllerGenerator('handles entity names with unconventional casing', 'userProfile', { 'base-path': '/api/user-profiles' }, '../test/templates/basic-microservice-flyway', [
