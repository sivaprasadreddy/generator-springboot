...
module.exports = class extends BaseGenerator {
    ...
    _generateDbMigrationConfig(configOptions) {
        ...
        if(configOptions.dbMigrationTool === 'liquibase') {
            const resTemplates = [
                {src: 'db/changelog/db.changelog-master.yaml', dest: 'db/changelog/db.changelog-master.yaml'},
                {src: 'db/changelog/migration/01-init.xml', dest: 'db/changelog/migration/01-init.xml'},
